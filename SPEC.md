...
```json
{
  ...
  "tables": [
    {"id": "t_0", "page": 4, "bbox": [...], "caption": "Table 1: ...", "html": "<table>...</table>"}
  ]
}
```
...
- `<SearchBar>` — recherche plein texte, compteur et navigation entre matches
- `<Tables>` — rendu HTML sanitize des tables extraites
...
- Recherche plein texte dans le viewer
- Export Markdown Docling
